		...
		<div id="printdiv" class="hidden">
			<div class="flex flex-col justify-center items-center">
				...
				<div class="flex items-center my-3">
					...
					%><h1 class="self-center text-2xl font-semibold whitespace-nowrap tracking-wide text-black">Books Based On Search Results for "<%=userInput%>"</h1><%
					} else {
					%><h1 class="self-center text-2xl font-semibold whitespace-nowrap tracking-wide text-black">Books</h1><%
					}
					%>
				</div>
