...
<body class="my-8 mx-48">
	...
	<h1 class="text-2xl font-bold tracking-wide mt-28 mb-8 p-0">Add
		Author</h1>
	<form class="mt-28"
		action="<%=request.getContextPath()%>/admin/AddAuthor" method="post">
		...
		%>
		<h1 class="successMessage tracking-wide">Author Added!</h1>
		<%
		} else if (statusCode.equals("409")) {
		%>
		<h1 class="errorMessage tracking-wide">Uh-oh! author already exists</h1>
		<%
