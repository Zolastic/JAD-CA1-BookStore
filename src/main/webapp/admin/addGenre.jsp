...
<body class="my-8 mx-48">
	...
	%>
	<h1 class="text-2xl font-bold tracking-wide mt-28 mb-8 p-0">Add Genre</h1>
	<form class="mt-28"
		action="<%=request.getContextPath()%>/admin/AddGenre" method="post" enctype="multipart/form-data">
		...
		%>
		<h1 class="errorMessage tracking-wide">Uh-oh! genre already exists</h1>
		<%
		...
		<button type="submit"
			class="text-amber-800 bg-pink-100 hover:bg-pink-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Add Genre</button>
	</form>
</body>
</html>