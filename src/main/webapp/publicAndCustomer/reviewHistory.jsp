...
<body>
	<%
	List<Review> reviewHistory = (List<Review>) request.getAttribute("reviewHistory");
	...
	%>
	<div>
	<div class="shadow-lg m-5 px-5 py-8 border border-gray-200 rounded-2xl mb-10">
		<div class="px-10">
